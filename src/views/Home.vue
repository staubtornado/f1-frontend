 ...
 * 
 * Benutzer können hier eine F1-Saison aus einer Dropdown-Liste auswählen.
 * Nachdem eine Saison ausgewählt wurde, werden sie zur Results-Seite weitergeleitet,
 * wo sie die Wochenenden und Sessions dieser Saison durchsuchen können.
 */
...
/**
 * Behandelt die Saison-Auswahl des Benutzers
 * Navigiert zur Results-Seite mit der ausgewählten Saison als Query-Parameter
 */
const handleSeasonSelect = () => {
  if (selectedSeason.value !== null) {
    router.push({ name: 'Results', query: { season: selectedSeason.value } })
  }
}
